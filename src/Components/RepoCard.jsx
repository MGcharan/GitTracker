...
const RepoCard = ({ liveDemo, name, description, topics, htmlUrl, language, }) => {
  ...
  return (
    <>
      {/* <!-- Card 1 --> */}
      <div className={`transform transition cursor-pointer hover:-translate-y-2 ml-10 relative flex items-center px-6 py-4 ${language === "JavaScript" ? "bg-yellow-500" : language === "SCSS" ? "bg-orange-600" : language === "HTML" ? "bg-red-600" : language === "CSS" ? "bg-pink-500" : language === "Vue" ? "bg-green-500" : language === "Ruby" ? "bg-red-900" : language === "Python" ? "bg-yellow-400" : language === "Java" ? "bg-orange-900" : language === "Shell" ? "bg-green-500" : "bg-blue-500"} text-white rounded mb-10 flex-col md:flex-row space-y-4 md:space-y-0`}>
