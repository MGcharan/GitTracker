    ...
    <header className={`flex justify-between ${theme === "dark" ? 'bg-slate-800' : "bg-black"} items-center p-5 px-4 md:px-40`}>
      ...
      <ul id="mobile-menu" className={`hidden md:hidden absolute z-10 top-16 left-0 ${theme === "dark" ? "bg-slate-800" : "bg-black"} w-full flex flex-col items-center`}>
        <li onClick={mobileMenuClose} className="p-3">
          <NavLink to="/" className={(navData) => navData.isActive ? "text-yellow-400" : ""}>
            Home
          </NavLink>
        </li>
        <li onClick={mobileMenuClose} className="p-3">
          <NavLink to="/myprofile" className={(navData) => navData.isActive ? "text-yellow-400" : ""}>
            My Profile
          </NavLink>
        </li>
        {/* <li onClick={mobileMenuClose} className="p-3">
